...
const faqs = [
  ...
  { q: 'PAC + ballon thermodynamique à 1 € : est-ce possible ?', a: '1 € n\'est ni un prix forfaitaire ni un résultat garanti : c\'est un reste à charge possible uniquement dans certains dossiers. Il faut distinguer deux projets : une pompe à chaleur seule, et une pompe à chaleur associée à un chauffe-eau thermodynamique. Le second inclut un équipement et une pose supplémentaires : son reste à charge peut donc différer de celui de la PAC seule. Les aides mobilisables (MaPrimeRénov\', prime CEE, TVA réduite) et les éventuelles remises commerciales dépendent de chaque dossier (revenus, logement, travaux, règles en vigueur). Seul un devis détaillé établit le montant final, selon la formule : prix TTC des équipements et de la pose – aides confirmées – remises applicables = reste à charge. Ce montant vous est présenté et validé avant tout engagement.' },
