...
const faqs = [
  ...
  { q: 'Pompe à chaleur à 1 € : est-ce possible, avec ou sans ballon thermodynamique ?', a: '1 € n\'est ni un prix forfaitaire ni un résultat garanti : c\'est un reste à charge envisageable uniquement dans certains dossiers, lorsque le cumul des aides (MaPrimeRénov\', prime CEE), d\'éventuelles remises commerciales et le prix du projet s\'y prêtent. Ce calcul se fait séparément pour une pompe à chaleur seule et pour un projet complet avec chauffe-eau thermodynamique : un reste à charge très faible sur la PAC seule ne signifie pas que le ballon et sa pose soient inclus au même tarif. Le montant exact dépend de vos revenus, de votre logement, des travaux retenus et des règles en vigueur. Le prix TTC des équipements et de la pose, les aides réellement mobilisables, les éventuelles remises et votre reste à charge final vous sont détaillés dans un devis, avant tout engagement.' },
