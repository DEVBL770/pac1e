...
const stepsData = [
  ...
  },
  {
    ...
    description: 'Un expert vous contacte pour étudier la faisabilité de votre projet et établir un devis détaillé.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    title: 'Installation',
    description: 'Si vous acceptez le devis, un professionnel qualifié installe votre pompe à chaleur.'
  },
];
